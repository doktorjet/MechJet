...
Зависимости: lib.ks (GUI/stat.ks пока убрана)
******************
...
BURN(VectorFunction,%Threshold) - прожигает в направлении вектора, возвращаемого VectorFunction пока ддлина вектора не уменьшится до Threshold (по умолчанию 0.1). (Иногда вызывает неожиданные баги.).
...
Значение MODE или "launch_rocket" или "orbital_stuff" (пока что).
