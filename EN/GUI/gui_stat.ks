...
LOCAL ttl IS SSG:addlabel("<size=16><b>MechJet: Parameters</b></size>").
...
V1:addlabel("<b>OSpd (m/s):</b>").
V1:addlabel("<b>AP (km):</b>").
V1:addlabel("<b>PE (km):</b>").
V1:addlabel("<b>INC:</b>").
V3:addlabel("<b>SSpd (m/s):</b>").
...
LOCAL SS_HD IS SSG:ADDBUTTON("Hide").
